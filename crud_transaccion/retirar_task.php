<?php
    ...
    if (isset($_POST['transaccion'])) {
        ...
        $_SESSION['message']='retirado exitosamente';
    ...
    <div class="row">
        <div class="col-md-4 mx-auto">
            <div class="card card-body">
                <form action="retirar_task.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    ...
                    <button class="btn btn-danger" name="transaccion">retirar</button>
                </form>
            </div>
        </div>
    </div>
